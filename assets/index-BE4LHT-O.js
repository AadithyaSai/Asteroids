    ...
    vec4 filterVertexPosition( void )
{
    ...
    void main(void)
    {
        ...
        %blur%
    }`;function Ac(n,e){const t=Math.ceil(n/2);let r=bc,i="",s;e?s="vBlurTexCoords[%index%] =  textureCoord + vec2(%sampleIndex% * pixelStrength, 0.0);":s="vBlurTexCoords[%index%] =  textureCoord + vec2(0.0, %sampleIndex% * pixelStrength);";for(let o=0;o<n;o++){let a=s.replace("%index%",o.toString());a=a.replace("%sampleIndex%",`${o-(t-1)}.0`),i+=a,i+=`
`}return r=r.replace("%blur%",i),r=r.replace("%size%",n.toString()),r=r.replace("%dimension%",e?"z":"w"),r}function Sc(n,e){const t=Ac(e,n),r=_c(e);return B.from({vertex:t,fragment:r,name:`blur-${n?"horizontal":"vertical"}-pass-filter`})}var Cc=`
...
`,Vc=`struct ExtractBrightnessUniforms {
  uThreshold: f32,
};
...
}`,Ih=Object.defineProperty,zh=(n,e,t)=>e in n?Ih(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,Ae=(n,e,t)=>(zh(n,typeof e!="symbol"?e+"":e,t),t);const Oh=class eo extends D{constructor(...e){let t=e[0]??{};if((t instanceof z||t instanceof _e)&&(R("6.0.0","ColorMapFilter constructor params are now options object. See params: { colorMap, nearest, mix }"),t={colorMap:t},e[1]!==void 0&&(t.nearest=e[1]),e[2]!==void 0&&(t.mix=e[2])),t={...eo.DEFAULT_OPTIONS,...t},!t.colorMap)throw Error("No color map texture source was provided to ColorMapFilter");const r=U.from({vertex:{source:N,entryPoint:"mainVertex"},fragment:{source:Mh,entryPoint:"mainFragment"}}),i=B.from({vertex:G,fragment:Fh,name:"color-map-filter"});super({gpuProgram:r,glProgram:i,resources:{colorMapUniforms:{uMix:{value:t.mix,type:"f32"},uSize:{value:0,type:"f32"},uSliceSize:{value:0,type:"f32"},uSlicePixelSize:{value:0,type:"f32"},uSliceInnerSize:{value:0,type:"f32"}},uMapTexture:t.colorMap.source,uMapSampler:t.colorMap.source.style}}),Ae(this,"uniforms"),Ae(this,"_size",0),Ae(this,"_sliceSize",0),Ae(this,"_slicePixelSize",0),Ae(this,"_sliceInnerSize",0),Ae(this,"_nearest",!1),Ae(this,"_scaleMode","linear"),Ae(this,"_colorMap"),this.uniforms=this.resources.colorMapUniforms.uniforms,Object.assign(this,t)}get mix(){return this.uniforms.uMix}set mix(e){this.uniforms.uMix=e}get colorSize(){return this._size}get colorMap(){return this._colorMap}set colorMap(e){if(!e||e===this.colorMap)return;const t=e instanceof z?e.source:e;t.style.scaleMode=this._scaleMode,t.autoGenerateMipmaps=!1,this._size=t.height,this._sliceSize=1/this._size,this._slicePixelSize=this._sliceSize/this._size,this._sliceInnerSize=this._slicePixelSize*(this._size-1),this.uniforms.uSize=this._size,this.uniforms.uSliceSize=this._sliceSize,this.uniforms.uSlicePixelSize=this._slicePixelSize,this.uniforms.uSliceInnerSize=this._sliceInnerSize,this.resources.uMapTexture=t,this._colorMap=e}get nearest(){return this._nearest}set nearest(e){this._nearest=e,this._scaleMode=e?"nearest":"linear";const t=this._colorMap;t&&t.source&&(t.source.scaleMode=this._scaleMode,t.source.autoGenerateMipmaps=!1,t.source.style.update(),t.source.update())}updateColorMap(){const e=this._colorMap;e!=null&&e.source&&(e.source.update(),this.colorMap=e)}destroy(){var e;(e=this._colorMap)==null||e.destroy(),super.destroy()}};Ae(Oh,"DEFAULT_OPTIONS",{colorMap:z.WHITE,nearest:!1,mix:1});var Eh=`in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Rh=`struct ColorOverlayUniforms {
    uColor: vec3<f32>,
    uAlpha: f32,
};
...
fn mainFragment(
    ...
    return finalColor;
}`,Yh=Object.defineProperty,Wh=(n,e,t)=>e in n?Yh(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,ro=(n,e,t)=>(Wh(n,typeof e!="symbol"?e+"":e,t),t);const Hh=class io extends D{constructor(...e){let t=e[0]??{};Array.isArray(t)&&(R("6.0.0","ConvolutionFilter constructor params are now options object. See params: { matrix, width, height }"),t={matrix:t},e[1]!==void 0&&(t.width=e[1]),e[2]!==void 0&&(t.height=e[2])),t={...io.DEFAULT_OPTIONS,...t};const r=t.width??200,i=t.height??200,s=U.from({vertex:{source:N,entryPoint:"mainVertex"},fragment:{source:$h,entryPoint:"mainFragment"}}),o=B.from({vertex:G,fragment:Xh,name:"convolution-filter"});super({gpuProgram:s,glProgram:o,resources:{convolutionUniforms:{uMatrix:{value:t.matrix,type:"mat3x3<f32>"},uTexelSize:{value:{x:1/r,y:1/i},type:"vec2<f32>"}}}}),ro(this,"uniforms"),this.uniforms=this.resources.convolutionUniforms.uniforms,this.width=r,this.height=i}get matrix(){return this.uniforms.uMatrix}set matrix(e){e.forEach((t,r)=>{this.uniforms.uMatrix[r]=t})}get width(){return 1/this.uniforms.uTexelSize.x}set width(e){this.uniforms.uTexelSize.x=1/e}get height(){return 1/this.uniforms.uTexelSize.y}set height(e){this.uniforms.uTexelSize.y=1/e}};ro(Hh,"DEFAULT_OPTIONS",{matrix:new Float32Array(9),width:200,height:200});var jh=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
fn mainFragment(
  ...
  return color;
}`,uf=Object.defineProperty,lf=(n,e,t)=>e in n?uf(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,Qe=(n,e,t)=>(lf(n,typeof e!="symbol"?e+"":e,t),t);const cf=class ao extends D{constructor(e){e={...ao.DEFAULT_OPTIONS,...e};const t=U.from({vertex:{source:N,entryPoint:"mainVertex"},fragment:{source:af,entryPoint:"mainFragment"}}),r=B.from({vertex:G,fragment:of,name:"drop-shadow-filter"});super({gpuProgram:t,glProgram:r,resources:{dropShadowUniforms:{uAlpha:{value:e.alpha,type:"f32"},uColor:{value:new Float32Array(3),type:"vec3<f32>"},uOffset:{value:e.offset,type:"vec2<f32>"}}},resolution:e.resolution}),Qe(this,"uniforms"),Qe(this,"shadowOnly",!1),Qe(this,"_color"),Qe(this,"_blurFilter"),Qe(this,"_basePass"),this.uniforms=this.resources.dropShadowUniforms.uniforms,this._color=new X,this.color=e.color??0,this._blurFilter=new $s({strength:e.kernels??e.blur,quality:e.kernels?void 0:e.quality}),this._basePass=new D({gpuProgram:U.from({vertex:{source:N,entryPoint:"mainVertex"},fragment:{source:`
                    @group(0) @binding(1) var uTexture: texture_2d<f32>; 
                    @group(0) @binding(2) var uSampler: sampler;
                    @fragment
                    fn mainFragment(
...
`,Cf=`// Taken from https://gist.github.com/munrocket/236ed5ba7e409b8bdf1ff6eca5dcdc39
...
}`,_d=Object.defineProperty,bd=(n,e,t)=>e in n?_d(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,tn=(n,e,t)=>(bd(n,typeof e!="symbol"?e+"":e,t),t);const Ad=class Ao extends D{constructor(...e){let t=e[0]??{};if(t instanceof z&&(R("6.0.0","SimpleLightmapFilter constructor params are now options object. See params: { lightMap, color, alpha }"),t={lightMap:t},e[1]!==void 0&&(t.color=e[1]),e[2]!==void 0&&(t.alpha=e[2])),t={...Ao.DEFAULT_OPTIONS,...t},!t.lightMap)throw Error("No light map texture source was provided to SimpleLightmapFilter");const r=U.from({vertex:{source:N,entryPoint:"mainVertex"},fragment:{source:yd,entryPoint:"mainFragment"}}),i=B.from({vertex:G,fragment:vd,name:"simple-lightmap-filter"});super({gpuProgram:r,glProgram:i,resources:{simpleLightmapUniforms:{uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:t.alpha,type:"f32"},uDimensions:{value:new Float32Array(2),type:"vec2<f32>"}},uMapTexture:t.lightMap.source,uMapSampler:t.lightMap.source.style}}),tn(this,"uniforms"),tn(this,"_color"),tn(this,"_lightMap"),this.uniforms=this.resources.simpleLightmapUniforms.uniforms,this._color=new X,this.color=t.color??0,Object.assign(this,t)}apply(e,t,r,i){this.uniforms.uDimensions[0]=t.frame.width,this.uniforms.uDimensions[1]=t.frame.height,e.applyFilter(this,t,r,i)}get lightMap(){return this._lightMap}set lightMap(e){this._lightMap=e,this.resources.uMapTexture=e.source,this.resources.uMapSampler=e.source.style}get color(){return this._color.value}set color(e){this._color.setValue(e);const[t,r,i]=this._color.toArray();this.uniforms.uColor[0]=t,this.uniforms.uColor[1]=r,this.uniforms.uColor[2]=i}get alpha(){return this.uniforms.uAlpha}set alpha(e){this.uniforms.uAlpha=e}};tn(Ad,"DEFAULT_OPTIONS",{lightMap:z.WHITE,color:0,alpha:1});var Sd=`in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Id=Object.defineProperty,zd=(n,e,t)=>e in n?Id(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,Co=(n,e,t)=>(zd(n,typeof e!="symbol"?e+"":e,t),t);const Od=class wo extends D{constructor(e){e={...wo.DEFAULT_OPTIONS,...e};const t=U.from({vertex:{source:N,entryPoint:"mainVertex"},fragment:{source:Md,entryPoint:"mainFragment"}}),r=B.from({vertex:G,fragment:Fd,name:"twist-filter"});super({gpuProgram:t,glProgram:r,resources:{twistUniforms:{uTwist:{value:[e.radius??0,e.angle??0],type:"vec2<f32>"},uOffset:{value:e.offset,type:"vec2<f32>"}}},...e}),Co(this,"uniforms"),this.uniforms=this.resources.twistUniforms.uniforms}get radius(){return this.uniforms.uTwist[0]}set radius(e){this.uniforms.uTwist[0]=e}get angle(){return this.uniforms.uTwist[1]}set angle(e){this.uniforms.uTwist[1]=e}get offset(){return this.uniforms.uOffset}set offset(e){this.uniforms.uOffset=e}get offsetX(){return this.offset.x}set offsetX(e){this.offset.x=e}get offsetY(){return this.offset.y}set offsetY(e){this.offset.y=e}};Co(Od,"DEFAULT_OPTIONS",{padding:20,radius:200,angle:4,offset:{x:0,y:0}});var Ed=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
